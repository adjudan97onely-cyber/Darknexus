...
const WebScraperPage = () => {
  ...
  const extractTypes = [
    ...
    { id: 'tables', name: 'Tableaux', icon: <Table className="w-4 h-4" />, description: 'DonnÃ©es tabulaires' },
    ...
    { id: 'lists', name: 'Listes', icon: <List className="w-4 h-4" />, description: 'Listes Ã  puces et numÃ©rotÃ©es' }
  ];
  ...
  const handleScrape = async () => {
    ...
    try {
      ...
      toast({
        title: "âœ… Scraping rÃ©ussi !",
        description: `DonnÃ©es extraites de ${response.data.title}`
      });
    } catch (error) {
          ...
          {result.text && (
            <div className="bg-slate-800/50 p-4 rounded-lg">
              <h3 className="text-white font-semibold mb-2 flex items-center">
                ...
                Texte Extrait ({result.text.length} caractÃ¨res)
              </h3>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <h1 className="text-4xl font-bold text-white mb-3">Extraire des DonnÃ©es Web</h1>
            <p className="text-slate-400 text-lg">Scrapez n'importe quel site web et extrayez les donnÃ©es structurÃ©es</p>
          </div>
          ...
          <Card className="bg-slate-900/50 border-slate-800">
            <CardHeader>
              ...
              <CardDescription className="text-slate-400">
                Entrez l'URL et choisissez le type de donnÃ©es Ã  extraire
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              {/* URL */}
