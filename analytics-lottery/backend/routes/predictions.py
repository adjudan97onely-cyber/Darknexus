...
# from sqlalchemy.orm import Session  # Remplacé par TinyDB
from datetime import datetime, timedelta
from typing import List, Optional

from database_sqlite import get_db_session, save_prediction, get_predictions
# from models.predictions_model import Prediction, Result, Evaluation  # Remplacé par TinyDB
...
def get_predictions(
    ...
    if pred_type:
        query = query.filter(Prediction.type == pred_type)
