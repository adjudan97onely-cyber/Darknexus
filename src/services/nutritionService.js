...
const SNACK_OPTIONS = {
  lose: [
    { id: "snack-fruit-yaourt", name: "Yaourt 0% + fruit frais", category: "collation", tags: ["leger", "proteine"], image: "https://source.unsplash.com/600x400/?yogurt-fruit-snack", prepMinutes: 2, cookMinutes: 0, difficulty: "Facile", ingredients: ["100 g yaourt nature 0%", "1 fruit (pomme, poire, orange)"], steps: ["Coupe le fruit.", "Sers avec le yaourt."], tips: ["Pomme = satiete longue."], mistakes: [], nutrition: { kcal: 125, protein: 7, carbs: 18, fat: 1 } },
    { id: "snack-eau-citron", name: "Eau petillante citron menthe", category: "collation", tags: ["boisson", "leger"], image: "https://source.unsplash.com/600x400/?sparkling-water-lemon-mint", prepMinutes: 2, cookMinutes: 0, difficulty: "Facile", ingredients: ["500 ml eau petillante", "1/2 citron vert", "Menthe fraiche"], steps: ["Presse citron.", "Ajoute menthe + glace."], tips: ["Coupe la faim sans calories."], mistakes: [], nutrition: { kcal: 10, protein: 0, carbs: 2, fat: 0 } },
    { id: "snack-concombre-piment", name: "Concombre citron piment", category: "collation", tags: ["leger", "croquant"], image: "https://source.unsplash.com/600x400/?cucumber-lime-pepper-snack", prepMinutes: 3, cookMinutes: 0, difficulty: "Facile", ingredients: ["1/2 concombre", "Citron vert", "Sel, piment"], steps: ["Rondelles + citron + sel + piment."], tips: [], mistakes: [], nutrition: { kcal: 25, protein: 1, carbs: 5, fat: 0 } },
  ],
  gain: [
    { id: "snack-noix-banane", name: "Noix + banane + yaourt grec", category: "collation", tags: ["proteine", "energie"], image: "https://source.unsplash.com/600x400/?nuts-banana-protein", prepMinutes: 3, cookMinutes: 0, difficulty: "Facile", ingredients: ["30 g noix de cajou", "1 banane", "150 g yaourt grec"], steps: ["Yaourt + banane + noix."], tips: ["Parfait post-entrainement."], mistakes: [], nutrition: { kcal: 320, protein: 18, carbs: 34, fat: 14 } },
    { id: "snack-pain-cacahuete", name: "Pain complet beurre cacahuete", category: "collation", tags: ["proteine", "energie"], image: "https://source.unsplash.com/600x400/?peanut-butter-toast-snack", prepMinutes: 2, cookMinutes: 0, difficulty: "Facile", ingredients: ["2 tranches pain complet", "2 c. a soupe beurre de cacahuete 100%", "1 banane"], steps: ["Tartine + banane."], tips: ["Beurre cacahuete 100% sans sucre ajoute."], mistakes: [], nutrition: { kcal: 380, protein: 14, carbs: 44, fat: 16 } },
  ],
  maintain: [
    { id: "snack-fruits-oleagineux", name: "Amandes + fruits secs", category: "collation", tags: ["equilibre", "fibre"], image: "https://source.unsplash.com/600x400/?almonds-dried-fruits", prepMinutes: 1, cookMinutes: 0, difficulty: "Facile", ingredients: ["20 g amandes", "20 g raisins secs"], steps: ["Melange et consomme."], tips: ["30g max d'oleagineux."], mistakes: [], nutrition: { kcal: 190, protein: 5, carbs: 20, fat: 10 } },
    { id: "snack-yaourt-miel", name: "Yaourt grec miel amandes", category: "collation", tags: ["equilibre", "proteine"], image: "https://source.unsplash.com/600x400/?greek-yogurt-honey-almonds", prepMinutes: 2, cookMinutes: 0, difficulty: "Facile", ingredients: ["150 g yaourt grec", "1 c. a cafe miel", "10 amandes"], steps: ["Yaourt + miel + amandes."], tips: [], mistakes: [], nutrition: { kcal: 200, protein: 12, carbs: 18, fat: 8 } },
  ],
};
