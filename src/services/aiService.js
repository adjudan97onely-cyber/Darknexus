...
const CULINARY_KNOWLEDGE = [
  ...
  {
    key: "bokit-crevettes",
    aliases: ["bokit crevettes", "bokit-crevettes", "bokit crevettes flamboyant"],
    cuisine: "antillaise",
    slot: "snack",
    fundamentals: ["pate levee", "friture chaude", "sauce crevettes riche"],
    baseIngredients: ["farine", "crevettes", "lait de coco", "oignon", "ail"],
  },
  {
    key: "colombo-porc",
    aliases: ["colombo porc", "colombo-porc", "colombo de porc savoureux"],
    cuisine: "antillaise",
    slot: "lunch",
    fundamentals: ["marinare porc", "epices colombo", "braiser lent"],
    baseIngredients: ["porc", "colombo", "oignon", "ail", "lait de coco"],
  },
  {
    key: "riz-blanc",
    aliases: ["riz blanc", "riz-blanc", "riz blanc creole"],
    cuisine: "antillaise",
    slot: "side",
    fundamentals: ["rinçage du riz", "cuisson vapor hermetic", "repos final"],
    baseIngredients: ["riz blanc", "eau", "beurre", "oignon", "sel"],
  },
  {
    key: "bananes-plantain-frites",
    aliases: ["bananes plantain frites", "plantain frites", "frites plantain", "platanos fritos"],
    cuisine: "antillaise",
    slot: "side",
    fundamentals: ["plantains vertes", "friture chaude", "salage immediat"],
    baseIngredients: ["plantain", "huile", "sel"],
  },
  {
    key: "frites-igname",
    aliases: ["frites igname", "igname frites", "chrips igname"],
    cuisine: "antillaise",
    slot: "side",
    fundamentals: ["igname verdure", "trempage amidon", "friture temperature"],
    baseIngredients: ["igname", "huile", "sel"],
  },
  {
    key: "gratin-banane-jaune",
    aliases: ["gratin banane jaune", "gratin banane", "banane jaune gratin"],
    cuisine: "antillaise",
    slot: "side",
    fundamentals: ["bechamel riche", "bananes jaunes mures", "couronne croustillante"],
    baseIngredients: ["banane jaune", "beurre", "lait", "fromage", "farine"],
  },
  {
    key: "puree-igname",
    aliases: ["puree igname", "igname puree", "puree d igname"],
    cuisine: "antillaise",
    slot: "side",
    fundamentals: ["igname blanche cuite", "ecrasement manuel", "liaison onctueuse"],
    baseIngredients: ["igname", "beurre", "lait", "ail", "sel"],
  },
  {
    key: "foufou-banane",
    aliases: ["foufou banane", "foufou", "foufou traditionnelle"],
    cuisine: "antillaise",
    slot: "side",
    fundamentals: ["bananes vertes ecrasees", "bain-marie", "garnit...e savourez"],
    baseIngredients: ["banane verte", "beurre", "oignon", "lait de coco", "morue"],
  },
  {
    key: "sauce-chien",
    aliases: ["sauce chien", "sauce-chien", "sauce piquante chien"],
    cuisine: "antillaise",
    slot: "condiment",
    fundamentals: ["piments frais", "jus citron frais", "herbes aromatiques"],
    baseIngredients: ["piment", "citron", "ail", "oignon", "persil"],
  },
  {
    key: "marinade-creole",
    aliases: ["marinade creole", "marinade-creole", "marinade antillaise"],
    cuisine: "antillaise",
    slot: "condiment",
    fundamentals: ["jus citron", "ail herbes", "huile equilibre"],
    baseIngredients: ["citron", "ail", "oignon", "persil", "huile"],
  },
  {
    key: "base-colombo",
    aliases: ["base colombo", "poudre colombo", "colombo poudre", "base-colombo"],
    cuisine: "antillaise",
    slot: "spice",
    fundamentals: ["curcuma cumin", "dorage epices", "stockage hermetique"],
    baseIngredients: ["curcuma", "cumin", "coriandre", "gingembre"],
  },
  {
    key: "sauce-piment",
    aliases: ["sauce piment", "sauce-piment", "sauce piment vinaigre"],
    cuisine: "antillaise",
    slot: "condiment",
    fundamentals: ["piments mijotes vinaigre", "balance sucre acide", "maceration"],
    baseIngredients: ["piment", "vinaigre", "sucre", "sel"],
  },
  {
    key: "huile-pimentee",
    aliases: ["huile pimentee", "huile-pimentee", "huile piment"],
    cuisine: "antillaise",
    slot: "condiment",
    fundamentals: ["infusion lente huile", "piments entiers", "stockage obscur"],
    baseIngredients: ["huile", "piment", "ail", "sel"],
  },
  {
    key: "ragout-porc",
    aliases: ["ragout porc", "ragoût-porc", "ragout de porc creole"],
    cuisine: "antillaise",
    slot: "lunch",
    fundamentals: ["sear viande", "mijotage lent", "legumes tardifs"],
    baseIngredients: ["porc", "oignon", "ail", "tomate", "lait de coco"],
  },
  {
    key: "grillade-porc",
    aliases: ["grillade porc", "grillade-porc", "porc grille marine"],
    cuisine: "antillaise",
    slot: "lunch",
    fundamentals: ["marinade longue citron", "gril chaud", "sear court"],
    baseIngredients: ["porc", "citron", "ail", "oignon", "thym"],
  },
  {
    key: "fricassee-lambi",
    aliases: ["fricassee lambi", "fricassee-lambi", "lambi fricassee"],
    cuisine: "antillaise",
    slot: "lunch",
    fundamentals: ["lambi nettoye", "blanchissage tendre", "sauce riche"],
    baseIngredients: ["lambi", "oignon", "ail", "lait de coco", "thym"],
  },
  {
    key: "cabri-massale",
    aliases: ["cabri massale", "cabri-massale", "chevre massale antillaise"],
    cuisine: "antillaise",
    slot: "lunch",
    fundamentals: ["chevre trempage", "poudre massale", "braiser long"],
    baseIngredients: ["chevre", "massale", "oignon", "ail", "lait de coco"],
  },
  {
    key: "poulet-saute-creole",
    aliases: ["poulet saute creole", "poulet-saute", "poulet creole saute"],
    cuisine: "antillaise",
    slot: "lunch",
    fundamentals: ["poulet sear", "sauce collo", "legumes ajout tardif"],
    baseIngredients: ["poulet", "oignon", "ail", "tomate", "lait de coco"],
  },
  {
    key: "court-bouillon-crevettes",
    aliases: ["court-bouillon crevettes", "court bouillon crevettes", "crevettes court-bouillon"],
    cuisine: "antillaise",
    slot: "dinner",
    fundamentals: ["sauce aromate chaude", "crevettes pochage court", "finition citron"],
    baseIngredients: ["crevettes", "tomate", "oignon", "ail", "citron"],
  },
  {
    key: "fricassee-chatrou",
    aliases: ["fricassee chatrou", "fricassee-chatrou", "poulpe fricassee"],
    cuisine: "antillaise",
    slot: "dinner",
    fundamentals: ["poulpe blanchissage lent", "sear court apres", "sauce enrichis"],
    baseIngredients: ["poulpe", "tomate", "oignon", "ail", "lait de coco"],
  },
  {
    key: "poisson-frit-marine",
    aliases: ["poisson frit marine", "poisson-frit", "poisson frit creole"],
    cuisine: "antillaise",
    slot: "dinner",
    fundamentals: ["marine citron aromate", "farine enrobage", "sauce marine finale"],
    baseIngredients: ["poisson", "citron", "oignon", "poivron", "farine"],
  },
  {
    key: "boudin-noir",
    aliases: ["boudin noir", "boudin-noir", "boudin noir creole"],
    cuisine: "antillaise",
    slot: "snack",
    fundamentals: ["sang porc liquide", "boyau remplissage", "poaching doux"],
    baseIngredients: ["sang porc", "porc", "oignon", "ail", "epices"],
  },
  {
    key: "boudin-blanc",
    aliases: ["boudin blanc", "boudin-blanc", "boudin blanc antillais"],
    cuisine: "antillaise",
    slot: "snack",
    fundamentals: ["porc hache lait", "boyau remplissage", "poaching doux"],
    baseIngredients: ["porc", "œuf", "pain", "lait", "epices"],
  },
  {
    key: "jambon-noel-ananas",
    aliases: ["jambon noel", "jambon-noel", "jambon ananas fete"],
    cuisine: "antillaise",
    slot: "fete",
    fundamentals: ["marinade rhum ananas", "cuisson lente arrosage", "repos repos"],
    baseIngredients: ["jambon", "ananas", "clous girofle", "rhum", "sucre"],
  },
  {
    key: "pois-dangole-riz",
    aliases: ["pois dangole riz", "pois d angole", "pois-dangole", "djon djon"],
    cuisine: "antillaise",
    slot: "fete",
    fundamentals: ["pois trempage", "riz absorption", "lard croustillant"],
    baseIngredients: ["pois", "riz", "lard", "oignon", "ail"],
  },
  {
    key: "pate-sale",
    aliases: ["pate salee", "pate-salee", "pate creole salée"],
    cuisine: "antillaise",
    slot: "fete",
    fundamentals: ["pate brisee simple", "farce porc epicee", "friture dore"],
    baseIngredients: ["farine", "beurre", "porc", "oignon", "piment"],
  },
  {
    key: "soupe-giromon",
    aliases: ["soupe giromon", "soupe-giromon", "giraumont potage"],
    cuisine: "antillaise",
    slot: "fete",
    fundamentals: ["giraumon ultra-cuit", "mixage veloute", "creme liaison"],
    baseIngredients: ["giraumon", "oignon", "ail", "bouillon", "creme"],
  },
  {
    key: "court-bouillon-fete",
    aliases: ["court-bouillon fete", "court-bouillon-fete", "court bouillon elegant"],
    cuisine: "antillaise",
    slot: "fete",
    fundamentals: ["sauce riche tomate", "trois poissons", "poaching progressif"],
    baseIngredients: ["poisson", "crevettes", "lambi", "tomate", "vin blanc"],
  },
  {
    key: "flan-coco",
    aliases: ["flan coco", "flan-coco", "flan antillais coco"],
    cuisine: "antillaise",
    slot: "dessert",
    fundamentals: ["caramel pale", "bain-marie lent", "refroidissement long"],
    baseIngredients: ["œuf", "lait coco", "lait concentre sucre", "sucre", "noix coco"],
  },
  {
    key: "blanc-manger-coco",
    aliases: ["blanc-manger coco", "blanc manger", "blancmanger"],
    cuisine: "antillaise",
    slot: "dessert",
    fundamentals: ["lait doux chaud", "fecule liaison", "refroidissement"],
    baseIngredients: ["lait coco", "lait entier", "sucre", "fecule mais", "noix coco"],
  },
  {
    key: "tourment-amour",
    aliases: ["tourment amour", "tourment-amour", "tourment d amour"],
    cuisine: "antillaise",
    slot: "dessert",
    fundamentals: ["pate brisee fragile", "farce coco pateuse", "glacage sirop"],
    baseIngredients: ["farine", "beurre", "sucre", "noix coco", "citron"],
  },
  {
    key: "gateau-ananas",
    aliases: ["gateau ananas", "gateau-ananas", "cake ananas"],
    cuisine: "antillaise",
    slot: "dessert",
    fundamentals: ["pate moellesse", "rondelles ananas", "sirop imbibition"],
    baseIngredients: ["ananas", "farine", "beurre", "œuf", "sucre"],
  },
  {
    key: "sorbet-coco",
    aliases: ["sorbet coco", "sorbet-coco", "glace coco"],
    cuisine: "antillaise",
    slot: "dessert",
    fundamentals: ["lait coco sirop", "congelation churn", "texture lisse"],
    baseIngredients: ["lait coco", "eau", "sucre", "vanille"],
  },
  {
    key: "pain-doux",
    aliases: ["pain doux", "pain-doux", "pain sucre antillais"],
    cuisine: "antillaise",
    slot: "dessert",
    fundamentals: ["pate enrichie sucre", "repos progression", "sucre cristalise"],
    baseIngredients: ["farine", "levure", "sucre", "œuf", "beurre"],
  },
  {
    key: "jus-goyave",
    aliases: ["jus goyave", "jus-goyave", "goyave frais"],
    cuisine: "antillaise",
    slot: "boisson",
    fundamentals: ["goyave mure rose", "mixage mixer", "passage passoire"],
    baseIngredients: ["goyave", "eau", "sucre", "citron"],
  },
  {
    key: "jus-maracuja",
    aliases: ["jus maracuja", "jus-maracuja", "passion fruit juice", "maracuja"],
    cuisine: "antillaise",
    slot: "boisson",
    fundamentals: ["maracuja mous", "graines extraction", "jus frais"],
    baseIngredients: ["maracuja", "eau", "sucre"],
  },
  {
    key: "jus-bissap",
    aliases: ["jus bissap", "jus-bissap", "hibiscus juice", "thé bissap"],
    cuisine: "antillaise",
    slot: "boisson",
    fundamentals: ["fleurs hibiscus infusion", "couleur rouge fonce", "refroidissement"],
    baseIngredients: ["hibiscus fleurs", "eau", "sucre", "gingembre"],
  },
  {
    key: "planteur",
    aliases: ["planteur", "punch planteur", "planteur punch"],
    cuisine: "antillaise",
    slot: "boisson",
    fundamentals: ["rhum blanc", "jus fruits", "epices infusion"],
    baseIngredients: ["rhum", "ananas", "goyave", "citron", "epices"],
  },
  {
    key: "rhum-arrange",
    aliases: ["rhum arrange", "rhum-arrange", "rhum maison maceration"],
    cuisine: "antillaise",
    slot: "boisson",
    fundamentals: ["fruits mûrs", "maceration lente", "rhum agricole"],
    baseIngredients: ["rhum", "fruits", "epices", "sucre"],
  },
];
