...
const ChatBot = ({ projectId, onCodeUpdate }) => {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      // Si l'IA a modifiÃ© le code, notifier le parent
  ...
  const handleVoiceTranscript = (transcript) => {
    // Remplacer l'input par la transcription complÃ¨te
    setInput(transcript);
  };
  ...
  const quickActions = [
    { label: "AmÃ©liorer le design", icon: "âœ¨", prompt: "AmÃ©liore le design de l'application avec des animations et des couleurs modernes" },
    { label: "Ajouter fonctionnalitÃ©", icon: "âž•", prompt: "Je veux ajouter une nouvelle fonctionnalitÃ© : " },
    { label: "Corriger bugs", icon: "ðŸ›", prompt: "Analyse le code et corrige tous les bugs potentiels" },
    { label: "Optimiser", icon: "âš¡", prompt: "Optimise les performances et la vitesse de l'application" }
  ];
      ...
      <div className="p-4 border-b border-slate-800">
        <div className="flex items-center space-x-2">
          ...
          <div>
            ...
            <p className="text-sm text-slate-400">PrÃªt Ã  vous aider</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        {messages.length === 0 ? (
          <div className="text-center text-slate-500 mt-8">
            ...
            <p className="text-sm">Demandez-moi d'amÃ©liorer, modifier ou corriger votre projet</p>
            ...
            <div className="flex items-start space-x-2">
              ...
              <Card className="p-3 bg-slate-800 border-slate-700">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-slate-300">L'IA rÃ©flÃ©chit...</span>
                </div>
              </Card>
            </div>
          </div>
        ...
        <div className="flex items-end space-x-2">
          <div className="flex-1 space-y-2">
            <Textarea
              ...
              placeholder="Demandez n'importe quoi : amÃ©liorer, modifier, corriger, ajouter..."
            ...
            <div className="flex items-center gap-2">
              <VoiceInput 
                ...
                showTranscript={true}
              />
              <span className="text-xs text-slate-500">ðŸŽ¤ Parlez en continu jusqu'au stop</span>
            </div>
          </div>
