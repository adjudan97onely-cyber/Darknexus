...
const AdminSettingsPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // VÃ©rifier d'abord l'ancien mot de passe en tentant une connexion
      ...
      toast({
        title: "âœ… SuccÃ¨s",
        description: "Mot de passe changÃ© avec succÃ¨s"
      });
      ...
      // Rediriger vers la page d'accueil aprÃ¨s 2 secondes
      setTimeout(() => {
        navigate('/');
      }, 2000);
          ...
          <Card className="bg-slate-900/50 border-slate-800">
            <CardHeader>
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  <CardTitle className="text-white text-2xl">ParamÃ¨tres Admin</CardTitle>
                  <CardDescription className="text-slate-400">
                    Changer votre mot de passe (Zone sÃ©curisÃ©e)
                  </CardDescription>
                </div>
              </div>
            </CardHeader>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="text-sm text-red-300">
                    ...
                    <p className="text-red-400/80">
                      Cette page est rÃ©servÃ©e aux administrateurs. Aucun utilisateur normal ne peut y accÃ©der.
