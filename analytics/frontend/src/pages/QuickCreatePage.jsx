...
const QuickCreatePage = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    description: '',
    type: '',
    ai_model: 'gpt-4o-mini'  // ModÃ¨le rapide par dÃ©faut
  });

  const quickModels = [
    { id: 'gpt-4o-mini', name: 'GPT-4o Mini (Ultra Rapide)', icon: 'âš¡' },
    { id: 'gpt-5.1', name: 'GPT-5.1 (Ã‰quilibrÃ©)', icon: 'â­' },
    { id: 'gemini-3-flash', name: 'Gemini 3 Flash (Rapide)', icon: 'ðŸš€' }
  ];
  ...
  const handleQuickGenerate = async () => {
    ...
    try {
        ...
        for (const line of lines) {
          try {
            ...
            if (data.status === 'success') {
              ...
              toast({
                title: "ðŸŽ‰ Projet crÃ©Ã© !",
                description: `${data.files_count} fichiers gÃ©nÃ©rÃ©s`
              });
            ...
            // Ignorer les lignes mal formatÃ©es
          }
        }
      }
    } catch (error) {
      ...
      toast({
        title: "Erreur",
        description: "Erreur lors de la gÃ©nÃ©ration",
        variant: "destructive"
      });
      setIsGenerating(false);
    }
        ...
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-8">
            <div className="inline-flex items-center space-x-2 bg-purple-500/10 border border-purple-500/20 rounded-full px-4 py-2 mb-4">
              ...
              <span className="text-purple-300 font-semibold text-sm">GÃ©nÃ©ration Rapide</span>
            </div>
            <h1 className="text-4xl font-bold text-white mb-3">CrÃ©ation Express</h1>
            <p className="text-slate-400 text-lg">Avec feedback en temps rÃ©el !</p>
          </div>
          ...
          <Card className="bg-slate-900/50 border-slate-800">
            <CardHeader>
              ...
              <CardDescription className="text-slate-400">
                Remplis les champs et regarde la magie opÃ©rer
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              {/* ModÃ¨le */}
              <div className="space-y-2">
                <Label htmlFor="model" className="text-slate-200">ModÃ¨le IA</Label>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-xs text-slate-400">âœ¨ Whisper AI :</span>
                    <WhisperVoiceInput 
                ...
                <Textarea
                  id="description"
                  placeholder="DÃ©cris ton projet rapidement..."
                ...
                <div className="space-y-3 bg-slate-800/50 p-4 rounded-lg border border-purple-500/30">
                  ...
                  {progress === 100 && (
                    <div className="flex items-center text-green-400 text-sm">
                      ...
                      GÃ©nÃ©ration terminÃ©e ! Redirection...
                    </div>
                  )}
                </div>
              )}
