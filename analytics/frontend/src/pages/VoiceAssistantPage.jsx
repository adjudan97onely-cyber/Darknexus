  ...
  const processVoiceCommand = async (command) => {
    ...
    try {
      ...
      if (response.data.is_command) {
        toast({
          title: "âœ… Commande reconnue !",
          description: response.data.confirmation
        });

        if (response.data.executed) {
          toast({
            title: "ðŸŽ‰ Action effectuÃ©e !",
            description: response.data.message
          });
        }
      } else {
        toast({
          title: "ðŸ’¬ Message capturÃ©",
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className="text-5xl font-bold text-white mb-4">
              ContrÃ´lez votre app <span className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">par la voix</span>
            </h1>
            <p className="text-slate-400 text-lg max-w-2xl mx-auto">
              Parlez naturellement Ã  l'assistant pour crÃ©er, modifier et amÃ©liorer vos projets sans toucher le clavier
            </p>
          </div>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex flex-col items-center justify-center p-8 bg-slate-800/50 rounded-lg border-2 border-dashed border-slate-700">
                  ...
                  <p className="text-sm text-slate-400 mt-4 text-center">
                    Appuyez sur le micro, parlez, puis arrÃªtez quand vous avez fini
                  </p>
                </div>
                ...
                {voiceInput && (
                  <div className="p-4 bg-slate-800 border border-slate-700 rounded-lg">
                    <p className="text-xs text-slate-400 mb-2">ðŸ“ DerniÃ¨re commande :</p>
                  ...
                  <div className={`p-4 rounded-lg border ${
                    ...
                    <div className="flex items-start space-x-3">
                      <Badge variant={commandResult.is_command ? "default" : "secondary"}>
                        {commandResult.is_command ? 'ðŸŽ¯ Commande' : 'ðŸ’¬ Message'}
                      </Badge>
                ...
                {conversationHistory.length > 0 && (
                  <div className="space-y-2">
                    <h3 className="text-sm font-semibold text-slate-300">ðŸ“œ Historique</h3>
              ...
              <CardContent>
                ...
                <div className="mt-6 p-4 bg-purple-900/20 border border-purple-800 rounded-lg">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="text-purple-300 font-semibold mb-2">ðŸ’¡ Astuce Pro</h4>
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-12">
            <Card className="bg-slate-900/50 border-slate-800">
              <CardContent className="pt-6">
                ...
                <p className="text-sm text-slate-400">
                  Parlez aussi longtemps que nÃ©cessaire, l'assistant capturera tout
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-slate-900/50 border-slate-800">
              <CardContent className="pt-6">
                ...
                <h3 className="text-white font-semibold mb-2">ComprÃ©hension Naturelle</h3>
                <p className="text-sm text-slate-400">
                  L'IA comprend vos intentions mÃªme si vous ne connaissez pas les commandes exactes
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-slate-900/50 border-slate-800">
              <CardContent className="pt-6">
                ...
                <h3 className="text-white font-semibold mb-2">Actions InstantanÃ©es</h3>
                <p className="text-sm text-slate-400">
                  Les commandes sont exÃ©cutÃ©es immÃ©diatement sans confirmation supplÃ©mentaire
                </p>
              </CardContent>
            </Card>
          </div>
