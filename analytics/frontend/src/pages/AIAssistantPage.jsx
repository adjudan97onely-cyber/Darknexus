...
/**
 * ASSISTANT IA - Interface identique Ã  Emergent
...
const AIAssistantPage = () => {
  ...
  const [messages, setMessages] = useState([
    {
      role: 'assistant',
      content: `ðŸ‘‹ Salut ! Je suis ton assistant IA personnel, exactement comme l'agent Emergent !

ðŸ’ª **Je peux t'aider Ã ** :
- CrÃ©er n'importe quel type de projet (web, Python, Excel, IA, etc.)
- Modifier et amÃ©liorer tes applications
- RÃ©pondre Ã  tes questions techniques
- DÃ©boguer ton code
- Te donner des conseils et des idÃ©es

ðŸŽ¤ **Comment m'utiliser** :
- Ã‰cris ta demande dans la zone de texte
- Ou clique sur le micro pour parler
- Je comprends le langage naturel, parle-moi comme Ã  un ami !

**Qu'est-ce que tu veux crÃ©er aujourd'hui ?** ðŸš€`,
  ...
  const handleFileSelect = (e) => {
    ...
    toast({
      title: "Fichiers ajoutÃ©s",
      description: `${files.length} fichier(s) ajoutÃ©(s)`
    });
  };
  ...
  const sendMessage = async () => {
    ...
    const progressMsg = {
      role: 'assistant',
      content: 'ðŸ”„ Traitement en cours...',
      timestamp: new Date().toISOString(),
      isProgress: true,
    ...
    try {
      // Convertir les images en base64 si prÃ©sentes
      const imageData = [];
      ...
      // Ajouter la rÃ©ponse de l'IA avec les Ã©tapes de progression
      const aiMessage = {
        role: 'assistant',
      ...
      // Si un projet a Ã©tÃ© crÃ©Ã©, proposer d'y aller
      if (response.data.project_id) {
        toast({
          title: "âœ¨ Projet crÃ©Ã© !",
          description: `${response.data.files_count} fichiers gÃ©nÃ©rÃ©s`,
          action: (
            <Button
              size="sm"
      ...
      const errorMessage = {
        role: 'assistant',
        content: `DÃ©solÃ©, j'ai rencontrÃ© un petit problÃ¨me ! ðŸ˜…

Peux-tu reformuler ta demande ? Ou essaie de :
- ÃŠtre plus prÃ©cis dans ta description
- Me dire quel type de projet tu veux crÃ©er
- Me demander de l'aide sur quelque chose de spÃ©cifique
...
Je suis lÃ  pour t'aider ! ðŸ’ª`,
      ...
      toast({
        title: "Erreur",
        description: "Impossible d'envoyer le message. RÃ©essaye !",
        variant: "destructive"
      });
    } finally {
      setIsLoading(false);
  ...
  const fileToBase64 = (file) => {
    return new Promise((resolve, reject) => {
      ...
      reader.onload = () => {
        // Extraire juste le base64 sans le prÃ©fixe data:image/...;base64,
  ...
  const quickPrompts = [
    "CrÃ©e-moi une application web de gestion de tÃ¢ches",
    "Comment crÃ©er un script Python pour automatiser Excel ?",
    "Aide-moi Ã  crÃ©er une landing page moderne",
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
      ...
      <div className="container mx-auto px-4 py-6 max-w-5xl">
        <div className="flex flex-col h-[calc(100vh-120px)]">
                    ...
                    <Card className={`p-4 ${
                      ...
                      {msg.progress && msg.progress.length > 0 && (
                        <div className="mt-3 space-y-1 border-t border-slate-700 pt-3">
                          <p className="text-xs font-semibold text-slate-400 mb-2">ðŸ“‹ Ã‰tapes :</p>
                      ...
                      {msg.files_created && msg.files_created.length > 0 && (
                        <div className="mt-3 border-t border-slate-700 pt-3">
                          <p className="text-xs font-semibold text-slate-400 mb-2">ðŸ“ Fichiers crÃ©Ã©s :</p>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <Card className="p-4 bg-slate-800 border-slate-700">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-sm text-slate-300">Je rÃ©flÃ©chis...</span>
                    </div>
                  </Card>
                </div>
              </div>
          ...
          {messages.length === 1 && (
            <div className="mb-4">
              <p className="text-sm text-slate-400 mb-2">ðŸ’¡ Suggestions rapides :</p>
          ...
          <Card className="bg-slate-900 border-slate-700 p-4">
            ...
            <div className="flex items-end space-x-2">
              <div className="flex-1">
                <Textarea
                  ...
                  placeholder="Ã‰cris ta demande ici... (Shift+Enter pour nouvelle ligne)"
            ...
            <p className="text-xs text-slate-500 mt-2 text-center">
              ðŸ’¡ Parle naturellement, je comprends le franÃ§ais ! â€¢ ðŸŽ¤ Clique sur le micro pour parler â€¢ ðŸ“Ž Ajoute des fichiers si besoin
            </p>
          </Card>
        </div>
      </div>
